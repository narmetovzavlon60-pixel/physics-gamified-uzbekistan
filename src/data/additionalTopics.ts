...
export const additionalTopics: PhysicsTopic[] = [
  {
    id: 'statics',
    moduleId: 'mechanics',
    ...
    details: { ru: 'Статика изучает условия равновесия тел под действием сил. Основное уравнение — равенство моментов сил.', uz: 'Statika jismlarning kuchlar ta\'sirida muvozanat shartlarini o\'rganadi. Asosiy tenglama — kuch momentlarining tengligi.' },
    formulas: [
  ...
  },
  {
    ...
    details: { ru: 'Линзы используются в очках, микроскопах, телескопах. Формула линзы связывает фокусное расстояние, расстояние до предмета и изображения.', uz: 'Linzalar ko\'zoynak, mikroskop, teleskoplarda ishlatiladi. Linza formulasi fokus masofasi, buyum va tasvirgacha masofalarni bog\'laydi.' },
    formulas: [
      ...
      { id: 'optical_power', latex: 'D = \\frac{1}{F}', description: { ru: 'Оптическая сила', uz: 'Optik kuch' } }
    ],
    tasks: [
      { id: 'lens1', title: { ru: 'Оптическая сила', uz: 'Optik kuch' }, description: { ru: 'Фокусное расстояние линзы 20 см. Найдите оптическую силу (дптр).', uz: 'Linzaning fokus masofasi 20 sm. Optik kuchini toping (dptr).' }, difficulty: 1, xpReward: 25, coinReward: 4, formulas: ['optical_power'], answer: 5 },
      ...
      { id: 'lens4', title: { ru: 'Фокусное расстояние', uz: 'Fokus masofa' }, description: { ru: 'Оптическая сила линзы 8 дптр. Найдите фокусное расстояние (см).', uz: 'Linzaning optik kuchi 8 dptr. Fokus masofasini toping (sm).' }, difficulty: 1, xpReward: 25, coinReward: 4, formulas: ['optical_power'], answer: 12.5 },
  ...
  },
  {
    ...
    details: { ru: 'Влажность воздуха характеризуется отношением парциального давления пара к давлению насыщенного пара при данной температуре.', uz: 'Havoning namligi parning parsial bosimining shu haroratdagi to\'yingan par bosimiga nisbati bilan tavsiflanadi.' },
    formulas: [
    ...
    tasks: [
      ...
      { id: 'hum4', title: { ru: 'Точка росы', uz: 'Shudring nuqtasi' }, description: { ru: 'При какой температуре парциальное давление пара 1.8 кПа станет насыщенным, если при 20°C давление насыщенного пара 2.3 кПа? Ответ: относительная влажность при 20°C (%).', uz: '20°C da to\'yingan par bosimi 2.3 kPa bo\'lsa, parsial bosim 1.8 kPa bo\'lgan par qanday haroratda to\'yinadi? Javob: 20°C dagi nisbiy namlik (%).' }, difficulty: 2, xpReward: 40, coinReward: 6, formulas: ['relative_humidity'], answer: 78.3 },
  ...
  },
  {
    ...
    details: { ru: 'Ядро состоит из протонов и нейтронов. Энергия связи определяется дефектом массы по формуле Эйнштейна.', uz: 'Yadro proton va neytronlardan iborat. Bog\'lanish energiyasi Eynshteyn formulasi bo\'yicha massa defekti orqali aniqlanadi.' },
    formulas: [
