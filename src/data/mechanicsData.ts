  ...
  topics: [
    {
      ...
      summary: { ru: 'Изучает движение тел, не рассматривая причины.', uz: 'Jismlar harakatini sabablarsiz o\'rganadi.' },
      ...
      tasks: [
        { id: 'kin1', title: { ru: 'Скорость автомобиля', uz: 'Avtomobil tezligi' }, description: { ru: 'Автомобиль проехал 120 км за 1.5 часа. Найдите среднюю скорость в км/ч.', uz: 'Avtomobil 120 km ni 1.5 soatda bosib o\'tdi. O\'rtacha tezlikni km/soatda toping.' }, difficulty: 1, xpReward: 30, coinReward: 5, formulas: ['v'], answer: 80 },
        { id: 'kin2', title: { ru: 'Торможение', uz: 'Tormozlanish' }, description: { ru: 'Тело двигалось со скоростью 20 м/с и остановилось за 4 с. Найдите модуль ускорения.', uz: 'Jism 20 m/s tezlik bilan harakatlanib, 4 s da to\'xtadi. Tezlanish modulini toping.' }, difficulty: 2, xpReward: 50, coinReward: 8, formulas: ['a'], answer: 5 },
        { id: 'kin3', title: { ru: 'Путь при разгоне', uz: 'Tezlanishda yo\'l' }, description: { ru: 'Тело начинает движение из состояния покоя с ускорением 2 м/с². Какой путь оно пройдёт за 5 с?', uz: 'Jism tinch holatdan 2 m/s² tezlanish bilan harakatni boshlaydi. 5 s da qancha yo\'l bosadi?' }, difficulty: 2, xpReward: 55, coinReward: 8, formulas: ['s'], answer: 25 },
        { id: 'kin4', title: { ru: 'Свободное падение', uz: 'Erkin tushish' }, description: { ru: 'Камень падает с высоты 45 м. Сколько секунд он будет падать? (g = 10 м/с²)', uz: 'Tosh 45 m balandlikdan tushadi. U necha sekund tushadi? (g = 10 m/s²)' }, difficulty: 3, xpReward: 70, coinReward: 10, formulas: ['s'], answer: 3 }
      ],
      quiz: [
    ...
    },
    {
      ...
      summary: { ru: 'Изучает причины движения тел — силы.', uz: 'Harakat sabablari — kuchlarni o\'rganadi.' },
      ...
      tasks: [
        { id: 'dyn1', title: { ru: 'Сила', uz: 'Kuch' }, description: { ru: 'Тело массой 5 кг движется с ускорением 2 м/с². Найдите силу в ньютонах.', uz: 'Massasi 5 kg bo\'lgan jism 2 m/s² tezlanish bilan harakatlanmoqda. Kuchni nyutonda toping.' }, difficulty: 1, xpReward: 30, coinReward: 5, formulas: ['F'], answer: 10 },
        { id: 'dyn2', title: { ru: 'Импульс', uz: 'Impuls' }, description: { ru: 'Тело массой 3 кг движется со скоростью 4 м/с. Найдите импульс (кг·м/с).', uz: 'Massasi 3 kg bo\'lgan jism 4 m/s tezlik bilan harakatlanmoqda. Impulsni (kg·m/s) toping.' }, difficulty: 1, xpReward: 35, coinReward: 5, formulas: ['p'], answer: 12 },
        { id: 'dyn3', title: { ru: 'Сила тяжести', uz: 'Og\'irlik kuchi' }, description: { ru: 'Масса тела 10 кг. Найдите силу тяжести (g = 10 м/с²).', uz: 'Jism massasi 10 kg. Og\'irlik kuchini toping (g = 10 m/s²).' }, difficulty: 2, xpReward: 40, coinReward: 6, formulas: ['Fgrav'], answer: 100 },
        { id: 'dyn4', title: { ru: 'Равнодействующая сила', uz: 'Teng ta\'sir etuvchi kuch' }, description: { ru: 'На тело действуют силы 3 Н и 4 Н под прямым углом. Найдите модуль равнодействующей.', uz: 'Jismga 3 N va 4 N kuchlar to\'g\'ri burchak ostida ta\'sir qiladi. Teng ta\'sir etuvchi kuch modulini toping.' }, difficulty: 3, xpReward: 60, coinReward: 9, formulas: ['F'], answer: 5 }
      ],
      quiz: [
    ...
    },
    {
      ...
      tasks: [
        { id: 'osc1', title: { ru: 'Период пружинного маятника', uz: 'Prujinali mayatnik davri' }, description: { ru: 'Груз массой 0.5 кг подвешен на пружине жёсткостью 50 Н/м. Найдите период колебаний (округлите до сотых).', uz: '0.5 kg massali yuk 50 N/m qattiqlikdagi prujinaga osilgan. Tebranish davrini toping (yuzdan birgacha yaxlitlang).' }, difficulty: 2, xpReward: 50, coinReward: 8, formulas: ['T'], answer: 0.63 },
        { id: 'osc2', title: { ru: 'Частота', uz: 'Chastota' }, description: { ru: 'Период колебаний 0.25 с. Найдите частоту (Гц).', uz: 'Tebranish davri 0.25 s. Chastotani toping (Hz).' }, difficulty: 1, xpReward: 30, coinReward: 5, formulas: ['freq'], answer: 4 }
      ],
      quiz: [
